...
public class UserEJB implements UserEJBLocal {
	...
	public void populate() {
		...
		UserEntity usertmp1= new UserEntity("Carlos", "pmWkWSBCL51Bfkhn79xPuKBKHz//H6B+mY6G9/eieuM=", "carlosantos3@gmail.com",
				"1970/06/13"); //pass 123
		em.persist(usertmp1);
		UserEntity	usertmp2 = new UserEntity("Duarte", "s6jg4fmrG/46NvIx9nb3i7MKUZ0rIebFMMDu6Ou0pdA=", "duarte3@gmail.com",
				"1985/10/21"); //pass 456
		em.persist(usertmp2);
